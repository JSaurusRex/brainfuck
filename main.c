 ...
 __attribute__((hot)) void runJIT ()
{
                        ...
                        if(funcs[r+counter*2] == eMove && last == eLoopOpen)
                        {
                            ...
                            if(condition)
                            {
                                ...
                                while(funcs[r+counter*2] == eAdd || funcs[r+counter*2] == eMove)
                                {
                                    ...
                                    #endif
                                    funcs[w+counter+2-condition] = funcs[r+counter*2+1];
                                    counter++;
                                }
                                counter--;
                                ...
                                if(counter == 3)
                                {
                                    ...
                                    funcs[w+1] = (void*)add;
                                    r += counter*2 + 2;
                                    w += counter-1; //overwrite last one
                                }else if(counter == 5)
                                {
                                    funcs[w] = &&gMul4;
                                    funcs[w+1] = (void*)add;
    ...
    gMul2:
    {
        ...
        #ifdef NEXTFUNC
            const void * restrict const nextfunc = *(currentfunc+3);
        #endif
    ...
    gMul4:
    {
        ...
        #ifdef NEXTFUNC
            const void * restrict const nextfunc = *(currentfunc+5);
        #endif
    ...
    gMul6:
    {
        ...
        #ifdef NEXTFUNC
            const void * restrict const nextfunc = *(currentfunc+7);
        #endif
